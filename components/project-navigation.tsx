...
export function ProjectNavigation({ category }: { category?: string }) {
  ...
  return <aside className="gl-directory" data-expanded={expanded}>
    <div className="gl-directory-inner">
      ...
      <div className="gl-directory-note"><span className="gl-state">{featuredProjects.length} FEATURED PROJECTS</span><p>Tools, printable hardware, and the working record behind them.</p></div>
