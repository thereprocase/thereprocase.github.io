...
export function ProjectNavigation({ category }: { category?: string }) {
  ...
  return <aside className="gl-directory" data-expanded={expanded}>
    <div className="gl-directory-inner">
      ...
      <div className="gl-directory-note"><span className="gl-state">{featuredProjects.length} PROJECTS</span><p>Each project page lists its status, source and downloads.</p></div>
