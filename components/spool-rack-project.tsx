    ...
    <div className="sr-page">
      <section className="gl-pane sr-hero" aria-labelledby="rack-title">
        ...
        <div className="sr-hero-grid">
          <div className="sr-hero-copy"><p className="gl-kicker">PRINTABLE HARDWARE / OPEN ENGINEERING</p><h1 id="rack-title">E13 spool wall rack.</h1><p>A wall-mounted, two-rail rack built around a compact printed bracket. Straight tapers reinforce the inner seat; flexible fingers retain the rods.</p><p className="sr-lede">CAD, print settings and stress analysis for the E13 bracket.</p><div className="sr-actions"><a className="gl-button sr-primary" href={downloads + 'bracket-with-modifier-helpers.step'} download>Download E13 STEP ↓</a><a className="gl-button" href="#engineering">Explore the engineering →</a></div><p className="sr-caption">Engineering prototype. Physical fit, hot-load and lifetime qualification remain.</p></div>
      ...
      <section className="gl-pane" id="downloads" aria-labelledby="downloads-title">
        <div className="gl-pane-title"><h2 id="downloads-title">04 / DOWNLOADS</h2><span>E13 DOWNLOADS</span></div>
      ...
      <section className="gl-pane" id="record" aria-labelledby="record-title">
        <div className="gl-pane-title"><h2 id="record-title">05 / PROJECT RECORD</h2><span>DESIGN → ANALYSIS → PHYSICAL CHECKS</span></div>
        <div className="sr-two-column"><div className="sr-copy"><h3>Earlier revisions: E11 and E12.</h3><p>E11 explored a deeper reinforcement. E12 reduced the protrusion. E13 adds straight tapers and a little depth, then follows the change through section checks, slicer paths and refined stress fields.</p><div className="sr-actions"><a className="gl-button" href={source + '/DESIGN-JOURNAL.md'}>Read the design journal ↗</a><a className="gl-button" href="https://github.com/thereprocase/spool-wall-rack">Open the repository ↗</a></div></div><div className="sr-copy sr-qualification"><h3>Physical tests still required.</h3><p>Check rod fit and snap retention, immediate loaded movement, dowel sag and wall contact. Measure drift under the intended warm service conditions and inspect for cracking or layer separation.</p><p>No physical proof test or lifetime qualification is claimed. All figures and downloads on this page come from the published E13 revision.</p></div></div>
      </section>
